...
export const models = [
  {
    ...
    footprint: '2.1 × 1.9 m',
    price: '£20,000',
    image: asset('frames/cabin-stray.webp'),
    alt: 'The Stray — a square western red cedar cube with one full-height window and a solid cedar door, standing on grass.',
  ...
  },
  {
    ...
    footprint: '3.0 × 2.2 m',
    price: '£29,000',
    image: asset('frames/cabin-nidd.webp'),
    alt: 'The Nidd — a longer cedar cabin with a high window band under the roofline and a covered threshold beside the door.',
  ...
  },
  {
    ...
    footprint: '4.2 × 2.4 m',
    price: '£37,000',
    image: asset('frames/cabin-fountains.webp'),
    alt: 'The Fountains — the largest cabin, a long cedar box with a wide window band lit warmly from within.',
